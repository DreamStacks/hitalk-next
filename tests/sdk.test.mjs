...
test('footer cat appears on one click and dismisses on click, Escape, timeout and pagehide without moving focus', async t => {
  vi.useFakeTimers()
  document.body.innerHTML =
    '<span class="hitalk-secret" data-hitalk-secret><button type="button" aria-label="叫小猫出来"></button></span>'
  t.onTestFinished(() => {
